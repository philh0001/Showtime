...
const styles = StyleSheet.create({
  ...
  stats: { marginTop: 24 },
  stat: { flexDirection: 'row', alignItems: 'center', gap: 16, paddingVertical: 18, borderBottomWidth: 1, borderBottomColor: '#29292F' },
  ...
  navigation: { color: '#FFFFFF', fontSize: 16, fontWeight: '700', paddingVertical: 20 },
  about: { marginTop: 20, paddingTop: 24, borderTopWidth: 1, borderTopColor: '#29292F', gap: 14 },
