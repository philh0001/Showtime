...
- The pending sync revision release needs D1 migration `0002_sync_revision.sql` before the matching API Worker, then a coordinated web release and two-device verification. Do not apply it during local feature work.
