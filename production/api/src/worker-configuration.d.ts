/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: c62f400299547e94e3bc2cdc35693264)
// Runtime types generated with workerd@1.20260915.1 2026-09-15 
interface __BaseEnv_Env {
	SHOWTIME_DB: D1Database;
	SEARCH_LIMITER: RateLimit;
	DISCOVERY_LIMITER: RateLimit;
	DETAILS_LIMITER: RateLimit;
	WORK_LIMITER: RateLimit;
	AUTH_LIMITER: RateLimit;
	SYNC_LIMITER: RateLimit;
	EMAIL_FROM: "Showtime <noreply@showtimetracker.show>";
	APP_NAME: "Showtime";
	APP_URL: "https://showtimetracker.show";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMAIL_FROM" | "APP_NAME" | "APP_URL" | "RESEND_VERIFICATION_TEMPLATE_ID" | "ALLOWED_ORIGINS">> {}
}
