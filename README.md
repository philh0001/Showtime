...
The product supports search, discovery, Watchlist, movie and TV progress, viewing history, upcoming episodes, optional accounts, and cloud sync. The current website release is v1.1.1, shown under Profile → About Showtime. Native apps are a possible later direction, not a current release target.
